        ...
        >
            ...
            >
                {workData.map((work, index) => (
                    <motion.div key={index} style={{ backgroundImage: `linear-gradient(to right, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${work.bgImage})` }} className='aspect-square bg-cover bg-center bg-no-repeat rounded-lg relative cursor-pointer group'
            ...
            <motion.a href="" className='w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-lightHover transition-all duration-500 dark:text-white dark:border-white dark:hover:bg-darkHover'
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
